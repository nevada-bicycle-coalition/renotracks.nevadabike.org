...
CREATE TABLE trip (
  ...
  stop       TIMESTAMP DEFAULT '0000-00-00 00:00:00',
  n_coord    INTEGER UNSIGNED,
  distance_mi DOUBLE,
  elevation_gain_ft INTEGER UNSIGNED,
  elevation_loss_ft INTEGER UNSIGNED,
  top_ft INTEGER UNSIGNED,
  bottom_ft INTEGER UNSIGNED,
  center_lat DOUBLE,
  center_lng DOUBLE,
  south_bound DOUBLE,
  west_bound DOUBLE,
...
CREATE TABLE note (
  ...
  recorded  TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  latitude  DOUBLE,
  longitude DOUBLE,
  altitude  DOUBLE,
  speed     DOUBLE,
